...
public class Cashier_main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RestaurantSystem/images/Cashier image.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          if(!usrname.getText().isEmpty()&&!pass.getText().isEmpty())
        {
             ...
             if(cas1.Login(UN, PW,"cashier") >0)
             {
                 cas1.employeeID  = cas1.Login(UN, PW,"cashier");
                 Cashier_view casv = new Cashier_view(cas1);
                 casv.setVisible(true);
                   this.dispose();
             }
             else
             {
